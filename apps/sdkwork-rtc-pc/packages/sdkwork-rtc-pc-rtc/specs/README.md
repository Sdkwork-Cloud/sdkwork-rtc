# SDKWork RTC PC Component Specs

This directory is the local standards index for `sdkwork-rtc-pc-rtc`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-rtc-pc-rtc` |
| Type | `react-package` |
| Root | `sdkwork-rtc/apps/sdkwork-rtc-pc/packages/sdkwork-rtc-pc-rtc` |
...
- `pnpm --filter sdkwork-rtc-pc-rtc typecheck`
