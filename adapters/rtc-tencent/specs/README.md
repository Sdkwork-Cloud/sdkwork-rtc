# SDKWork RTC Adapter Tencent Component Specs

This directory is the local standards index for `sdkwork-rtc-adapter-tencent`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-rtc-adapter-tencent` |
| Type | `rust-crate` |
| Root | `sdkwork-rtc/adapters/rtc-tencent` |
...
- `cargo test -p sdkwork-rtc-adapter-tencent`
