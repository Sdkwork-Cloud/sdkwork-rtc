# SDKWork RTC Adapter Aliyun Component Specs

This directory is the local standards index for `sdkwork-rtc-adapter-aliyun`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-rtc-adapter-aliyun` |
| Type | `rust-crate` |
| Root | `sdkwork-rtc/adapters/rtc-aliyun` |
...
- `cargo test -p sdkwork-rtc-adapter-aliyun`
