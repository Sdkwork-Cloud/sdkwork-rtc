# SDKWork RTC Adapter Volcengine Component Specs

This directory is the local standards index for `sdkwork-rtc-adapter-volcengine`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-rtc-adapter-volcengine` |
| Type | `rust-crate` |
| Root | `sdkwork-rtc/adapters/rtc-volcengine` |
...
- `cargo test -p sdkwork-rtc-adapter-volcengine`
