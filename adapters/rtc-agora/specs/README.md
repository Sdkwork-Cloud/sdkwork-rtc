# SDKWork RTC Adapter Agora Component Specs

This directory is the local standards index for `sdkwork-rtc-adapter-agora`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-rtc-adapter-agora` |
| Type | `rust-crate` |
| Root | `sdkwork-rtc/adapters/rtc-agora` |
...
- `cargo test -p sdkwork-rtc-adapter-agora`
