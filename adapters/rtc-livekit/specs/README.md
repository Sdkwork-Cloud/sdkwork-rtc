# SDKWork RTC Adapter LiveKit Component Specs

This directory is the local standards index for `sdkwork-rtc-adapter-livekit`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-rtc-adapter-livekit` |
| Type | `rust-crate` |
| Root | `sdkwork-rtc/adapters/rtc-livekit` |
...
- `cargo test -p sdkwork-rtc-adapter-livekit`
