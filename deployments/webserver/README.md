...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `rtc-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `rtc-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `rtc-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `rtc-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `rtc.sdkwork.com` | 443 ssl + 80 |
