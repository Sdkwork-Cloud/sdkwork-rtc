...
Module `sdkwork-rtc` · runtime code `rtc` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `rtc-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `rtc-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `rtc-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `rtc-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `rtc.sdkwork.com` | 443 ssl + 80 |
