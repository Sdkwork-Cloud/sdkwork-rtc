...
impl RtcProviderPort for LivekitRtcProvider {
    ...
    fn create_session(
        ...
        Ok(RtcSessionHandle {
            ...
            provider_session_id: format!("livekit:{}", request.rtc_session_id),
    ...
    fn issue_participant_credential(
        ...
        Ok(RtcParticipantCredential {
            ...
            rtc_session_id: rtc_session_id.into(),
            participant_id: participant_id.into(),
            credential: format!("livekit-token:{tenant_id}:{rtc_session_id}:{participant_id}"),
    ...
    fn provider_health_snapshot(&self) -> ProviderHealthSnapshot {
        ...
        details.insert("providerKind".into(), "livekit".into());
