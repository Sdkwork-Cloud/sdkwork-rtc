...
const components = [
  ...
  },
  {
    ...
    name: "sdkwork-router-rtc-app-api",
    ...
    verify: "cargo test -p sdkwork-router-rtc-app-api",
    routeManifest:
      "sdks/_route-manifests/app-api/sdkwork-router-rtc-app-api.route-manifest.json",
    runtimeEntrypoints: ["Cargo.toml"],
  },
  {
    crateDir: "crates/sdkwork-router-rtc-backend-api",
    name: "sdkwork-router-rtc-backend-api",
    ...
    verify: "cargo test -p sdkwork-router-rtc-backend-api",
    routeManifest:
  ...
  },
  {
    ...
    capability: "rtc",
    publicExports: [],
    verify: "cargo test -p sdkwork-rtc-api-server",
    routeManifest: null,
