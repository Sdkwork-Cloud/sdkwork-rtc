...
const prefixRegistry = {
  ...
  prefixes: [{ prefix: 'rtc_', owner: 'rtc-platform', domain: 'rtc' }],
};
...
process.stdout.write(`materialized ${tableNames.length} tables into rtc database contract\n`);
