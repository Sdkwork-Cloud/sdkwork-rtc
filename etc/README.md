# sdkwork-rtc Source Configuration
...
| `appId` | `sdkwork-rtc` |
| `runtimeCode` | `rtc` |
| Config root | `/etc/sdkwork/rtc/` |
| Runtime TOML | `/etc/sdkwork/rtc/config.toml` |
| Secrets | `/etc/sdkwork/rtc/secrets/` |
| Override | `SDKWORK_RTC_CONFIG_FILE` |
