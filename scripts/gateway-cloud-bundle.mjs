...
async function createBundleContext(options) {
  ...
  const stageName = `sdkwork-rtc-api-gateway-config-${version}`;
...
async function bundleCloudConfig(context) {
  ...
  for (const configName of RTC_CLOUD_GATEWAY_CONFIGS) {
  ...
  const readme = `# RTC Cloud Gateway Config Bundle
