...
use crate::{
    ...
    RtcPostgresProviderRouteRepository, RtcSqliteMediaSessionRepository,
...
pub async fn sqlite_list_rooms_page(
    repo: &RtcSqliteMediaSessionRepository,
    query: RtcScopedListQuery,
...
pub async fn sqlite_list_media_sessions_page(
    repo: &RtcSqliteMediaSessionRepository,
    query: RtcScopedListQuery,
...
pub async fn sqlite_list_active_provider_profiles_page(
    repo: &RtcSqliteProviderProfileRepository,
    query: RtcScopedListQuery,
...
pub async fn sqlite_list_media_artifacts_page(
    repo: &RtcSqliteMediaSessionRepository,
    query: RtcScopedListQuery,
...
pub async fn sqlite_list_media_artifacts_scope_page(
    repo: &RtcSqliteMediaSessionRepository,
    query: RtcScopedListQuery,
) -> Result<RtcMediaArtifactListPage, RtcPersistenceError> {
    let repo = repo.clone();
...
pub async fn sqlite_list_provider_profiles_page(
    repo: &RtcSqliteProviderProfileRepository,
    query: RtcScopedListQuery,
...
pub async fn sqlite_list_provider_accounts_page(
    repo: &RtcSqliteProviderAccountRepository,
    query: RtcScopedListQuery,
...
pub async fn sqlite_list_provider_applications_page(
    repo: &RtcSqliteProviderAccountRepository,
    query: RtcScopedListQuery,
...
pub async fn sqlite_list_provider_credentials_page(
    repo: &RtcSqliteProviderAccountRepository,
    query: RtcScopedListQuery,
...
pub async fn sqlite_list_provider_routes_page(
    repo: &RtcSqliteProviderRouteRepository,
    query: RtcScopedListQuery,
...
pub async fn sqlite_list_webhook_events_page(
    repo: &RtcSqliteProviderEventRepository,
    query: RtcScopedListQuery,
...
pub async fn sqlite_list_provider_query_snapshots_page(
    repo: &RtcSqliteProviderEventRepository,
    query: RtcScopedListQuery,
...
pub async fn sqlite_list_quality_samples_scope_page(
    repo: &RtcSqliteMediaSessionRepository,
    query: RtcScopedListQuery,
