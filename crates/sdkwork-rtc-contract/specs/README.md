# SDKWork RTC Contract Component Specs

This directory is the local standards index for `sdkwork-rtc-contract`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-rtc-contract` |
| Type | `rust-crate` |
| Root | `sdkwork-rtc/crates/sdkwork-rtc-contract` |
...
- `cargo test -p sdkwork-rtc-contract`
