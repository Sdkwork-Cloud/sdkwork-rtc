# SDKWork RTC Signaling Service Component Specs

This directory is the local standards index for `sdkwork-rtc-signaling-service`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-rtc-signaling-service` |
| Type | `rust-crate` |
| Root | `sdkwork-rtc/services/sdkwork-rtc-signaling-service` |
...
- `cargo test -p sdkwork-rtc-signaling-service`
