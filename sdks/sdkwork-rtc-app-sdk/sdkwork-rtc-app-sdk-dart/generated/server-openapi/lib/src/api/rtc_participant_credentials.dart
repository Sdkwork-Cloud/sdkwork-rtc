...
class RtcParticipantCredentialsApi {
  ...
  RtcParticipantCredentialsApi(this._client);

  /// Rtc media Sessions participant Credentials issue.
  Future<RtcParticipantCredentialResponse?> rtcMediaSessionsParticipantCredentialsIssue(String mediaSessionId, String participantId, Map<String, dynamic> body, [String? idempotencyKey]) async {
    ...
    final payload = body;
    final response = await _client.post(ApiPaths.appPath('/rtc/media_sessions/${serializePathParameter(mediaSessionId, const PathParameterSpec('mediaSessionId', 'simple', false))}/participants/${serializePathParameter(participantId, const PathParameterSpec('participantId', 'simple', false))}/credential'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : RtcParticipantCredentialResponse.fromJson(map);
    })();
  }
}
