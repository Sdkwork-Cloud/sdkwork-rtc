...
export class RtcRecordingArtifactsRtcMediaSessionsRecordingArtifactsApi {
...
/** Rtc media Sessions recording Artifacts list. */
  async list(mediaSessionId: string, params?: RtcRecordingArtifactsRtcMediaSessionsRecordingArtifactsListParams): Promise<RtcMediaArtifactListResponse> {
    ...
    return this.client.get<RtcMediaArtifactListResponse>(appendQueryString(appApiPath(`/rtc/media_sessions/${serializePathParameter(mediaSessionId, { name: 'mediaSessionId', style: 'simple', explode: false })}/recording_artifacts`), query));
  }
}
...
export function createRtcRecordingArtifactsApi(client: HttpClient): RtcRecordingArtifactsApi {
