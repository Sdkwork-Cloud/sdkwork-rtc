...
/** Rtc rooms list. */
  async list(params?: RtcRoomsRtcRoomsListParams): Promise<SdkWorkListResponse> {
    ...
    return this.client.get<SdkWorkListResponse>(appendQueryString(appApiPath(`/rtc/rooms`), query));
  }

/** Rtc rooms retrieve. */
  async retrieve(roomId: string): Promise<RtcRoomsRetrieveResponse> {
    return this.client.get<RtcRoomsRetrieveResponse>(appApiPath(`/rtc/rooms/${serializePathParameter(roomId, { name: 'roomId', style: 'simple', explode: false })}`));
  }
}
