...
export const RTC_PROVIDER_PACKAGE_STATUSES = freezeRtcRuntimeValue(['package_reference_boundary'] as const);
...
export const VOLCENGINE_RTC_PROVIDER_PACKAGE_ENTRY: RtcProviderPackageCatalogEntry = freezeRtcRuntimeValue({
  ...
  requiredCapabilities: freezeRtcRuntimeValue(['session', 'credential', 'provider.webhook', 'health', 'media.audio', 'media.video', 'live.broadcast', 'live.audience', 'provider.event-normalization'] as const),
  optionalCapabilities: freezeRtcRuntimeValue(['screen-share', 'recording', 'artifact', 'cloud-mix', 'provider.active-query'] as const),
...
export const TENCENT_RTC_PROVIDER_PACKAGE_ENTRY: RtcProviderPackageCatalogEntry = freezeRtcRuntimeValue({
  ...
  runtimeBridgeStatus: 'reference-baseline',
  requiredCapabilities: freezeRtcRuntimeValue(['session', 'credential', 'provider.webhook', 'health', 'media.audio', 'media.video', 'live.broadcast', 'live.audience', 'provider.event-normalization'] as const),
  optionalCapabilities: freezeRtcRuntimeValue(['screen-share', 'recording', 'artifact', 'cdn-relay', 'provider.active-query'] as const),
...
export const AGORA_RTC_PROVIDER_PACKAGE_ENTRY: RtcProviderPackageCatalogEntry = freezeRtcRuntimeValue({
  ...
  runtimeBridgeStatus: 'reserved',
  requiredCapabilities: freezeRtcRuntimeValue(['session', 'credential', 'provider.webhook', 'health', 'media.audio', 'media.video', 'live.broadcast', 'live.audience', 'provider.event-normalization'] as const),
  optionalCapabilities: freezeRtcRuntimeValue(['screen-share', 'recording', 'artifact', 'cloud-mix', 'data-channel', 'spatial-audio', 'e2ee', 'provider.active-query'] as const),
...
export const ZEGO_RTC_PROVIDER_PACKAGE_ENTRY: RtcProviderPackageCatalogEntry = freezeRtcRuntimeValue({
  ...
  runtimeBridgeStatus: 'reserved',
  requiredCapabilities: freezeRtcRuntimeValue(['session', 'credential', 'provider.webhook', 'health', 'media.audio', 'media.video', 'live.broadcast', 'live.audience', 'provider.event-normalization'] as const),
  optionalCapabilities: freezeRtcRuntimeValue(['screen-share', 'recording', 'artifact', 'cloud-mix', 'beauty', 'provider.active-query'] as const),
...
export const LIVEKIT_RTC_PROVIDER_PACKAGE_ENTRY: RtcProviderPackageCatalogEntry = freezeRtcRuntimeValue({
  ...
  runtimeBridgeStatus: 'reserved',
  requiredCapabilities: freezeRtcRuntimeValue(['session', 'credential', 'provider.webhook', 'health', 'media.audio', 'media.video', 'live.broadcast', 'live.audience', 'provider.event-normalization'] as const),
  optionalCapabilities: freezeRtcRuntimeValue(['screen-share', 'recording', 'artifact', 'data-channel', 'transcription', 'e2ee', 'provider.active-query'] as const),
...
export const TWILIO_RTC_PROVIDER_PACKAGE_ENTRY: RtcProviderPackageCatalogEntry = freezeRtcRuntimeValue({
  ...
  runtimeBridgeStatus: 'reserved',
  requiredCapabilities: freezeRtcRuntimeValue(['session', 'credential', 'provider.webhook', 'health', 'media.audio', 'media.video', 'live.broadcast', 'live.audience', 'provider.event-normalization'] as const),
  optionalCapabilities: freezeRtcRuntimeValue(['screen-share', 'recording', 'artifact', 'data-channel', 'provider.active-query'] as const),
...
export const JITSI_RTC_PROVIDER_PACKAGE_ENTRY: RtcProviderPackageCatalogEntry = freezeRtcRuntimeValue({
  ...
  runtimeBridgeStatus: 'reserved',
  requiredCapabilities: freezeRtcRuntimeValue(['session', 'credential', 'provider.webhook', 'health', 'media.audio', 'media.video', 'live.broadcast', 'live.audience', 'provider.event-normalization'] as const),
  optionalCapabilities: freezeRtcRuntimeValue(['screen-share', 'recording', 'artifact', 'transcription', 'provider.active-query'] as const),
...
export const JANUS_RTC_PROVIDER_PACKAGE_ENTRY: RtcProviderPackageCatalogEntry = freezeRtcRuntimeValue({
  ...
  runtimeBridgeStatus: 'reserved',
  requiredCapabilities: freezeRtcRuntimeValue(['session', 'credential', 'provider.webhook', 'health', 'media.audio', 'media.video', 'live.broadcast', 'live.audience', 'provider.event-normalization'] as const),
  optionalCapabilities: freezeRtcRuntimeValue(['data-channel', 'provider.active-query'] as const),
