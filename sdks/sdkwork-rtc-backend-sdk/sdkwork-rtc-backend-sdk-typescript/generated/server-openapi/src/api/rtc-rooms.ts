...
import type { RtcCreateRoomRequest, RtcRoom } from '../types';
...
export interface RtcRoomsRtcRoomsCreateParams {
...
/** Rtc rooms create. */
  async create(body: RtcCreateRoomRequest, params?: RtcRoomsRtcRoomsCreateParams, requestOptions?: ApiRequestOptions): Promise<RtcRoom> {
