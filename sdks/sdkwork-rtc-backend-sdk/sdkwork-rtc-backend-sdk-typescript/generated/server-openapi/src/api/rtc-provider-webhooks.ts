...
/** Rtc provider Webhooks events receive. */
  async receive(provider: string, body: RtcProviderWebhookReceiveRequest): Promise<RtcProviderWebhookEventResponse> {
    return this.client.request<RtcProviderWebhookEventResponse>(backendApiPath(`/rtc/provider_webhooks/${serializePathParameter(provider, { name: 'provider', style: 'simple', explode: false })}/events`), { method: 'POST' as any, body, contentType: 'application/json', skipAuth: true });
  }
