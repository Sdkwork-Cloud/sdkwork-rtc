...
export class RtcProviderWebhooksRtcProviderWebhooksEventsApi {
...
/** Rtc provider Webhooks events receive. */
  async receive(provider: string, body: RtcProviderWebhookReceiveRequest, params?: RtcProviderWebhooksRtcProviderWebhooksEventsReceiveParams): Promise<RtcProviderWebhookEventResponse> {
    ...
    return this.client.request<RtcProviderWebhookEventResponse>(backendApiPath(`/rtc/provider_webhooks/${serializePathParameter(provider, { name: 'provider', style: 'simple', explode: false })}/events`), { method: 'POST' as any, body, headers: requestHeaders, contentType: 'application/json', skipAuth: true });
  }

/** Rtc provider Webhooks events list. */
  async list(params?: RtcProviderWebhooksRtcProviderWebhooksEventsListParams): Promise<RtcProviderWebhookEventListResponse> {
    ...
    return this.client.get<RtcProviderWebhookEventListResponse>(appendQueryString(backendApiPath(`/rtc/provider_webhooks/events`), query));
  }
}
...
export function createRtcProviderWebhooksApi(client: HttpClient): RtcProviderWebhooksApi {
