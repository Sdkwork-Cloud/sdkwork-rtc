...
class RtcRoomsApi {
  ...
  Future<RtcRoomListResponse?> list([int? page, int? pageSize, String? cursor, String? sort, String? q, String? status, String? ownerUserId, String? createdAfter]) async {
    ...
    return (() {
      ...
      return map == null ? null : RtcRoomListResponse.fromJson(map);
    })();
  }

  /// Rtc rooms create.
  Future<RtcRoomResponse?> create(RtcCreateRoomRequest body, [String? idempotencyKey]) async {
    ...
    final response = await _client.post(ApiPaths.backendPath('/rtc/rooms'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : RtcRoomResponse.fromJson(map);
    })();
  }

  /// Rtc rooms retrieve.
  Future<RtcRoomResponse?> retrieve(String roomId) async {
    final response = await _client.get(ApiPaths.backendPath('/rtc/rooms/${serializePathParameter(roomId, const PathParameterSpec('roomId', 'simple', false))}'));
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : RtcRoomResponse.fromJson(map);
    })();
